...
public final class FragmentFavoritesBinding implements ViewBinding {
  ...
  private FragmentFavoritesBinding(@NonNull LinearLayout rootView, @NonNull TextView headerText,
  ...
  public static FragmentFavoritesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFavoritesBinding((LinearLayout) rootView, headerText, list);
    }
