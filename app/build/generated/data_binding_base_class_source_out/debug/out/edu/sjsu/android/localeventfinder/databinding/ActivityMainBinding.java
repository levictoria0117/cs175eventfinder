...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull ConstraintLayout main,
      @NonNull View tabDivider, @NonNull TabLayout tabLayout, @NonNull ViewPager viewPager) {
    this.rootView = rootView;
    this.main = main;
    this.tabDivider = tabDivider;
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tabDivider;
      View tabDivider = ViewBindings.findChildViewById(rootView, id);
      if (tabDivider == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, main, tabDivider, tabLayout,
          viewPager);
    }
