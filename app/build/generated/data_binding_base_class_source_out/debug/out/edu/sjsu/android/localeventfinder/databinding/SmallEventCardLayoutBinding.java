...
public final class SmallEventCardLayoutBinding implements ViewBinding {
  @NonNull
  ...
  private SmallEventCardLayoutBinding(@NonNull MaterialCardView rootView,
  ...
  @NonNull
  public static SmallEventCardLayoutBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static SmallEventCardLayoutBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.small_event_card_layout, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static SmallEventCardLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SmallEventCardLayoutBinding((MaterialCardView) rootView, eventDate, eventImage,
